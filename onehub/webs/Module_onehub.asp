...
function get_notice_data(){
    ...
    $.ajax({
        type: "GET",
        url: "https://raw.githubusercontent.com/everstu/Koolcenter_recoverySoftcenter/refs/heads/master/notice/onehub.json?v=" + random,
        dataType: 'json',
        success: function(data) {
            //需要判断数据是否存在
            if(data["api_recommend"]){
                noticeData["api_recommend_html"] = data['api_recommend'];
            }
            if(data["notice"]){
                noticeData["notice_html"] = data['notice'];
            }
        }
    });
}
...
function popApiRecommend(){
    if(! noticeData["api_recommend_html"]){
        noticeData["api_recommend_html"] = "<ul style=\" font-family: 'Microsoft Yahei', sans-serif;color: yellow;font-size: 16px;line-height: 1.6;background:black;\"><br><br><li><a href=\"https://ppinfra.com/user/register?invited_by=7IIT1H\" target=\"_blank\" rel=\"noopener noreferrer\"><em><u>派欧云 - 点击接受邀请注册送余额</u></em></a>&nbsp;&nbsp;邀请码&nbsp;7IIT1H&nbsp;</li><br><li><a href=\"https://cloud.siliconflow.cn/i/jOOhe7rC\" target=\"_blank\" rel=\"noopener noreferrer\"><em><u>硅基流动 - 点击接受邀请注册送余额</u></em></a>&nbsp;&nbsp;邀请码&nbsp;jOOhe7rC&nbsp;</li><br><br></ul>"
    }
    layer.open({
        type: 1,
        title: false,
        ...
        area: ['500px'],
        shadeClose: true,
        content: noticeData["api_recommend_html"]
    });
    return false;
}
</script>
		...
		<table cellpadding="5" cellspacing="0" id="loadingBarBlock" class="loadingBarBlock" align="center">
			<tr>
				<td height="100">
					...
					<div id="loading_block_spilt" style="margin:10px 0 10px 5px;padding-left: 30px;" class="loading_block_spilt">
								...
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										...
										<div style="margin:10px 0 0 5px">
                                            <li><a href="#" onclick="popApiRecommend();return false;">点击查看提供<em>免费大模型API服务</em>的云厂商</a></li>
